...
class IncomeFormViewModel extends StateNotifier<IncomeFormState> {
  IncomeFormViewModel({
    required int? userId,
  ...
  Future<int> createIncomeCategory(String name) async {
    final userId = _requireUserId();
    return _categoryRepository.createIncomeCategory(
      userId: userId,
      name: name,
    );
  }
...
final incomeFormViewModelProvider =
    StateNotifierProvider.autoDispose<IncomeFormViewModel, IncomeFormState>(
  (ref) {
